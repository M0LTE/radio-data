...
namespace DotNetCoords
{
  ...
  public sealed class LatLng 
  {
    ...
    /// Equivalent to <code>ToDatum(WGS84Datum.Instance)</code>
    /// </summary>   
    public void ToWGS84() 
    {
    ...
    private void InternalToDatum(Datum.Datum d, bool toWgs)
    {
      ...
      var sc = 1 + ds;
      var xB = dx + (x * sc) + ((-rz * y) * sc) + ((ry * z) * sc);
    ...
    /// Equivalent to <code>ToDatum(OSGB36Datum.Instance)</code>
    /// </summary>
