...
namespace DotNetCoords
{
  ...
  public sealed class MGRSRef : CoordinateSystem 
  {
    ...
    */
    ...
    {
      return ToString(precision, "{0}{1}{2}{3}{4}{5}");
    }
    ...
    /// </summary>
    /// <param name="precision">The required precision.</param>
    /// <param name="format">The format. {0} will be replaced by the UTM zone number, {1} will be replaced by the UTM zone character,
    /// {2} will be replaced by the Easting ID, {3} will be replaced by the Northing ID, {4} will be replaced by the Easting, {5} will be replaced by the Northing</param>
    /// <returns>A string representation of this MGRS reference to the required
    /// precision.</returns>
    public string ToString(Precision precision, string format)
    { 
      ...
      return string.Format(format, utmZonePadding + UtmZoneNumber, UtmZoneChar,
        EastingId, NorthingId, eastingRs, northingRs);
    }
